...
set CLASSPATH=%APP_HOME%\lib\demo-1.0.0.jar;%APP_HOME%\lib\core-1.0.0.jar


@rem Execute demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" io.github.lifecache.demo.LifecacheDemo %*
